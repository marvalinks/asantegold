...
<section data-anim-wrap="" class="pageHeader -type-1 animated">
    ...
    <div class="container">
      <h1 data-anim-child="slide-up delay-1" class="pageHeader__title is-in-view">Image Media</h1>
    </div>
</section>
            ...
            <div class="row y-gap-20 justify-between items-end">
                <div class="col-auto">
                    <h2 class="text-62 md:text-38 uppercase fw-500">
                        <span class="text-accent-1">Image</span><br />
                        Media
                    </h2>
                </div>
                ...
                <div class="tabs__pane -tab-item-1 is-tab-el-active">
                    <div class="row y-gap-30">
                        ...
                        <div data-anim-child="slide-up delay-{{$key+1}}" class="col-xl-4 col-md-6 is-in-view">
                            <a href="{{$media->url}}" target="_blank" class="imageCard -type-2 hover-btn-explore">
                                <div class="imageCard__image relative ratio ratio-45:40 mb-0">
                                    <img src="{{$media->url}}" alt="image" class="img-ratio" />
